...
class Car(models.Model):
    ...
    provider = models.ForeignKey(Provider, related_name="cars_provided")
    brand = models.CharField(max_length=45)
    model = models.CharField(max_length=45)
    plate_number = models.CharField(max_length=45)
    production_year = models.IntegerField()
    engine = models.IntegerField()
    pickup_date = models.DateTimeField(null=True) #this field can be empty unless while creating car, unless its booked
...
class Feedback(models.Model):
    ...
    customer = models.ForeignKey(Customer,related_name="customer_feedbacks")
